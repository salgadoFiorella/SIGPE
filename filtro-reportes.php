  ...
  <body>
    <div class="container"><br>
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					<div class="card-header">Seleccione los campus correspondientes<b style="color: red;">*</b></div>
					<div class="card-body">
						<form method="post" action="seleccionar-Filtro.php" class="clearfix">
							<table class="table table-bordered">
								...
								while($row = mysqli_fetch_array($rs)){
								  echo '<tr><td>'.$row['Campus'].'</td>';
								  echo '<td><input type="checkbox" name="campus[]" value="'.$row['Id'].'"></td></tr>';
								}
								 ?> 
								</tbody>
							</table>
			...
			<div class="col-md-6">
				<div class="card">
					<div class="card-header">
						Información que desea incluir en el reporte
					</div>
					<div class="card-body">
